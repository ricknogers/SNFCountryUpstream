...
{
    return \GFPDF_Vendor\QueryPath::with($document, $string, $options);
}
/**
...
{
    return \GFPDF_Vendor\QueryPath::withHTML($document, $selector, $options);
}
/**
...
{
    return \GFPDF_Vendor\QueryPath::withHTML5($document, $selector, $options);
}
