...
class Selector implements \GFPDF_Vendor\QueryPath\CSS\EventHandler, \IteratorAggregate, \Countable
{
    ...
    {
        $this->currSelector->attributes[] = array('name' => $name, 'value' => $value, 'op' => $operation);
    }
    public function attributeNS($name, $ns, $value = NULL, $operation = \GFPDF_Vendor\QueryPath\CSS\EventHandler::isExactly)
    {
        $this->currSelector->attributes[] = array('name' => $name, 'value' => $value, 'op' => $operation, 'ns' => $ns);
    }
    ...
    {
        $this->combinator(\GFPDF_Vendor\QueryPath\CSS\SimpleSelector::directDescendant);
    }
    ...
    {
        $this->combinator(\GFPDF_Vendor\QueryPath\CSS\SimpleSelector::anyDescendant);
    }
}
