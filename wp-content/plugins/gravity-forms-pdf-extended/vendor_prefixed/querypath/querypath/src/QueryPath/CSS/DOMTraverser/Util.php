...
class Util
{
     ...
     */
    public static function matchesAttribute($node, $name, $value = NULL, $operation = \GFPDF_Vendor\QueryPath\CSS\EventHandler::isExactly)
    {
     ...
     */
    public static function matchesAttributeNS($node, $name, $nsuri, $value = NULL, $operation = \GFPDF_Vendor\QueryPath\CSS\EventHandler::isExactly)
    {
