...
abstract class Component implements \GFPDF_Vendor\League\Uri\Contracts\UriComponentInterface
{
    ...
    {
        if ($component instanceof \GFPDF_Vendor\League\Uri\Contracts\UriComponentInterface) {
        ...
        throw new \GFPDF_Vendor\League\Uri\Exceptions\SyntaxError(\sprintf('Invalid component string: %s.', $component));
    }
    /**
     ...
     * @return static
     */
    public abstract function withContent($content) : \GFPDF_Vendor\League\Uri\Contracts\UriComponentInterface;
}
