...
class MetadataWriter implements \Psr\Log\LoggerAwareInterface
{
     ...
     */
    private $logger;
    public function __construct(\GFPDF_Vendor\Mpdf\Mpdf $mpdf, \GFPDF_Vendor\Mpdf\Writer\BaseWriter $writer, \GFPDF_Vendor\Mpdf\Form $form, \GFPDF_Vendor\Mpdf\Pdf\Protection $protection, \Psr\Log\LoggerInterface $logger)
    {
        $this->mpdf = $mpdf;
        $this->writer = $writer;
        $this->form = $form;
