...
use GFPDF_Vendor\Aws\Sqs\SqsClient;
 ...
 */
class SqsHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    /** @var string */
    private $queueUrl;
    public function __construct(\GFPDF_Vendor\Aws\Sqs\SqsClient $sqsClient, string $queueUrl, $level = \GFPDF_Vendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if (\strlen($messageBody) >= static::MAX_MESSAGE_SIZE) {
            $messageBody = \GFPDF_Vendor\Monolog\Utils::substr($messageBody, 0, static::HEAD_MESSAGE_SIZE);
        }
