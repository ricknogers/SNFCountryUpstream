 ...
 */
class NativeMailerHandler extends \GFPDF_Vendor\Monolog\Handler\MailHandler
{
    /**
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \GFPDF_Vendor\Monolog\Formatter\LineFormatter($this->subject);
