 ...
 */
class OverflowHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractHandler implements \GFPDF_Vendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\GFPDF_Vendor\Monolog\Logger::DEBUG => 0, \GFPDF_Vendor\Monolog\Logger::INFO => 0, \GFPDF_Vendor\Monolog\Logger::NOTICE => 0, \GFPDF_Vendor\Monolog\Logger::WARNING => 0, \GFPDF_Vendor\Monolog\Logger::ERROR => 0, \GFPDF_Vendor\Monolog\Logger::CRITICAL => 0, \GFPDF_Vendor\Monolog\Logger::ALERT => 0, \GFPDF_Vendor\Monolog\Logger::EMERGENCY => 0];
    /**
