 ...
 */
class SlackWebhookHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * Slack Webhook token
     * @var string
    ...
    protected function write(array $record) : void
    {
        ...
        $postString = \GFPDF_Vendor\Monolog\Utils::jsonEncode($postData);
        $ch = \curl_init();
        ...
        \GFPDF_Vendor\Monolog\Handler\Curl\Util::execute($ch);
    }
