...
class MongoDBHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        if (!($mongodb instanceof \GFPDF_Vendor\MongoDB\Client || $mongodb instanceof \MongoDB\Driver\Manager)) {
            throw new \InvalidArgumentException('MongoDB\\Client or MongoDB\\Driver\\Manager instance required');
        }
        if ($mongodb instanceof \GFPDF_Vendor\MongoDB\Client) {
    ...
    {
        return new \GFPDF_Vendor\Monolog\Formatter\MongoDBFormatter();
    }
}
