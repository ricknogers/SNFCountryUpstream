...
use GFPDF_Vendor\Elastica\Client;
use GFPDF_Vendor\Elastica\Exception\ExceptionInterface;
/**
 ...
 */
class ElasticaHandler extends \GFPDF_Vendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * @var Client
     */
    ...
    {
        if ($formatter instanceof \GFPDF_Vendor\Monolog\Formatter\ElasticaFormatter) {
    ...
    protected function bulkSend(array $documents) : void
    {
        ...
        } catch (\GFPDF_Vendor\Elastica\Exception\ExceptionInterface $e) {
