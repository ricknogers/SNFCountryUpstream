 ...
 */
class HtmlFormatter extends \GFPDF_Vendor\Monolog\Formatter\NormalizerFormatter
{
    /**
    ...
    protected function convertToString($data) : string
    {
        ...
        return \GFPDF_Vendor\Monolog\Utils::jsonEncode($data, \JSON_PRETTY_PRINT | \GFPDF_Vendor\Monolog\Utils::DEFAULT_JSON_FLAGS, \true);
    }
}
