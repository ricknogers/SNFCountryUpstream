	...
	public function build_inline_styles() {
		...
		foreach ( $themes as $theme_key => $theme_styles ) {
			...
			if ( ! empty( $theme_styles['meta'] ) ) {
				$styles .= '.exactmetrics-popular-posts-styled.exactmetrics-widget-popular-posts.exactmetrics-widget-popular-posts-' . $theme_key . ' .exactmetrics-widget-popular-posts-list .exactmetrics-widget-popular-posts-meta span {';
			...
			if ( ! empty( $theme_styles['comments'] ) ) {
				$styles .= '.exactmetrics-widget-popular-posts.exactmetrics-popular-posts-styled.exactmetrics-widget-popular-posts-' . $theme_key . ' .exactmetrics-widget-popular-posts-list .exactmetrics-widget-popular-posts-comments {';
				...
				$styles .= '}';
				$styles .= '.exactmetrics-widget-popular-posts.exactmetrics-popular-posts-styled.exactmetrics-widget-popular-posts-' . $theme_key . ' .exactmetrics-widget-popular-posts-list .exactmetrics-widget-popular-posts-comments svg {';
			...
			if ( ! empty( $theme_styles['border']['color2'] ) ) {
				$styles .= '.exactmetrics-popular-posts-styled.exactmetrics-widget-popular-posts-' . $theme_key . ' .exactmetrics-inline-popular-posts-border-2 {';
