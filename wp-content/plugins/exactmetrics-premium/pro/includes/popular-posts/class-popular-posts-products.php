...
class ExactMetrics_Popular_Posts_Products extends ExactMetrics_Popular_Posts {
	...
	public function get_rendered_html( $atts ) {
		...
		foreach ( $posts as $post ) {
			...
			$html .= '<span class="exactmetrics-products-popular-posts-title" ' . $this->get_element_style( $theme, 'title', $atts ) . '>' . $post['title'] . '</span>';
			if ( $show_price ) {
				$html .= '<span class="exactmetrics-products-popular-posts-price" ' . $this->get_element_style( $theme, 'price', $atts ) . '>' . $post['price'] . '</span>';
			}
			if ( $show_rating ) {
				$rating_color = ! empty( $atts['rating_color'] ) ? $atts['rating_color'] : $theme_styles['styles']['rating']['color'];
				$html         .= '<span class="exactmetrics-products-popular-posts-rating">' . $this->get_rating_stars( $rating_color, $post['rating'] ) . '</span>';
			}
