...
class ExactMetrics_Popular_Posts_GA {
	...
	public function get_popular_posts_report() {
		...
		if ( ! $site_auth && ! $ms_auth ) {
			return array(
				'error'   => true,
				'message' => __( 'You must authenticate with ExactMetrics before you can view reports.', 'google-analytics-dashboard-for-wp' ),
			);
		}
		...
		return array(
			'error'   => true,
			'message' => __( 'We encountered an error when fetching the report data.', 'google-analytics-dashboard-for-wp' ),
		);
	}
