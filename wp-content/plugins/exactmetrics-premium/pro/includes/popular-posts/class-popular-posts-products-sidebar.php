...
class ExactMetrics_Popular_Posts_Products_Sidebar extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo ExactMetrics_Popular_Posts_Products()->shortcode_output( $atts );
	...
	public function form( $instance ) {
		...
		<div class="exactmetrics-widget-theme-preview">
			...
			<div class="exactmetrics-products-theme-preview-icon exactmetrics-products-theme-preview-icon-<?php echo esc_attr( $instance['theme'] ); ?>"></div>
		</div>
		...
		<p>
			...
			<select id="<?php echo esc_attr( $this->get_field_id( $name ) ); ?>"
				...
				<?php foreach ( $range as $font_size ) { ?>
					<option value="<?php echo absint( $font_size ); ?>" <?php selected( $instance[ $name ], $font_size ); ?>><?php printf( esc_html_x( '%dpx', 'exactmetrics-premium' ), $font_size ); ?></option>
				<?php } ?>
			</select>
		</p>
		<?php
