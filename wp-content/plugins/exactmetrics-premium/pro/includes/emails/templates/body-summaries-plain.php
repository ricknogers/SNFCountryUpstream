...
echo esc_html__( 'Total Visitors', 'exactmetrics-premium' ) . '   -   ' . number_format_i18n( $total_visitors ) . "\n";
echo $visitors_difference . "%\n\n";

echo esc_html__( 'Total Pageviews', 'exactmetrics-premium' ) . '   -   ' . number_format_i18n( $total_pageviews ) . "\n";
