	...
	public function prepare_report_data( $data ) {
		...
		if ( ! empty( $data['data'] ) ) {
			$data['data']['galinks'] = array(
				'toppages'  => 'https://analytics.google.com/analytics/web/#/realtime/rt-content/' . ExactMetrics()->auth->get_referral_url(),
				'referrals' => 'https://analytics.google.com/analytics/web/#/realtime/rt-traffic/' . ExactMetrics()->auth->get_referral_url(),
				'countries' => 'https://analytics.google.com/analytics/web/#/realtime/rt-location/' . ExactMetrics()->auth->get_referral_url(),
				'city'      => 'https://analytics.google.com/analytics/web/#/realtime/rt-location/' . ExactMetrics()->auth->get_referral_url(),
			);
		}
