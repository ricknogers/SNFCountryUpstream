	...
	public function prepare_report_data( $data ) {
		...
		if ( ! empty( $data['data'] ) ) {
			$data['data']['galinks'] = array(
				'forms' => 'https://analytics.google.com/analytics/web/#report/content-event-events/' . ExactMetrics()->auth->get_referral_url() . $this->get_ga_report_range( $data['data'] ) . '%3Fexplorer-table.plotKeys%3D%5B%5D%26_r.drilldown%3Danalytics.eventCategory%3Aform/',
			);
		}
