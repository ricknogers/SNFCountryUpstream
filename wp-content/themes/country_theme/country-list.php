...
<a class="countryModal btn-open-modal" role="button" data-toggle="modal" data-target="#myCountryListModal">Locations</a>
<!-- Modal Fullscreen xl -->
<div class="modal countryModalContent bd-example-modal-xl show" id="myCountryListModal" tabindex="-1" role="dialog" aria-hidden="true" aria-labelledby="myCountryListModal">
