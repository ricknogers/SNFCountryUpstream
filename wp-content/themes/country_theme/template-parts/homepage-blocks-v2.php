                                    ...
                                    <div class="card-right col-md-12 col-sm-12">
                                        <a href="<?php the_sub_field('call_to_action_button_link');?>">
                                            <?php if( get_sub_field('call_to_action_background_image') ): ?>
                                                <div class="cta-card-background-right" style="background-image: url(<?php the_sub_field("call_to_action_background_image") ;?>);"></div>
                                            <?php endif; ?>
                                        </a>
                                    </div>
                        ...
                        <?php if ($counter % 3 === 0) :?>
                            <div class="col-md-6 order-md-2   col-sm-12 subsidiaryItemContent">
                                <div class="card  h-100">
                                    <div class="view subsidiaryItemGraphic">
                                    ...
                                    <a href="<?php the_permalink();?>">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <?php endif;?>
                                            <?php echo '<p class="card-text">' . wp_trim_words( get_the_content(), 25, '' ) . '</p>'; ?>
                                        </div>
                                    </a>
                                </div>
                            </div>
